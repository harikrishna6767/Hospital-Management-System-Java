...
<nav class="navbar navbar-expand-lg">
    <div class="container-fluid">
        <div class="logo">
            <a href="index.jsp">Arogya Seva</a> <!-- Changed to index.jsp for homepage -->
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <%-- This is the navbar for LOGGED OUT users --%>
                <c:if test="${empty userObj and empty doctObj and empty adminObj}">
                ...
                <%-- (Optional) Add a similar block for doctObj and adminObj if they have different navbars --%>
